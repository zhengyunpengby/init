...
CREATE TABLE COUSTOMER(
	COUSTOMER_ID VARCHAR(32) NOT NULL COMMENT '客户ID',
	CERT_ID VARCHAR(21) COMMENT '证件ID',
	USERNAME VARCHAR(10) COMMENT '用户名',
	USERNAME_BAK VARCHAR(10) COMMENT '备用名',
	TEL1 VARCHAR(11) COMMENT '联系方式',
	TEL2 VARCHAR(20) COMMENT '备用联系方式',
	HOME_ADDRESS VARCHAR(100) COMMENT '家庭住址',
	COMMON_ADDRESS VARCHAR(100) COMMENT '常用住址',
	WORK_TYPE VARCHAR(100) COMMENT '工作类型',
	WORK_UNIT VARCHAR(100) COMMENT '工作单位',
	EMPTY_CD VARCHAR(1) COMMENT '是否为职工（Y：是，N：否）',
	REMARK VARCHAR(200) COMMENT '备注',
	STAT VARCHAR(1) COMMENT '状态（N：正常；D：废弃）',
	LOAD_DATE DATETIME NOT NULL COMMENT '加载日期',
	PRIMARY KEY (COUSTOMER_ID,LOAD_DATE)
);

ALTER TABLE COUSTOMER COMMENT = '客户信息表';

CREATE TABLE HOUSE(
	HOUSE_ID VARCHAR(32) NOT NULL COMMENT '房屋ID',
	COUSTOMER_ID VARCHAR(32) COMMENT '客户ID',
...
CREATE TABLE TRANLIST(
	...
	TRAN_COUSTOMER_ID VARCHAR(32) COMMENT '交易客户',
